...
const createTaskCard = (task) => {
  ...
  const cardDueDate = $("p").addClass("card-text").text(task.deuDate);
  ...
  if(task.deuDate && task.status !== "done" ) {
    const now = dayjs();
    const taskDueDate = dayjs(task.deuDate, "DD/MM/YYYY");
